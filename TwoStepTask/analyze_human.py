...
means = [0.851, 0.761, 0.625, 0.726]
sems = [0.03, 0.04, 0.037, 0.038]

plt.bar(np.arange(4), means, color=['C0', 'C1', 'C0', 'C1'], alpha=0.7, yerr=sems)
plt.ylim(0.5, 1)
...
plt.tight_layout()
plt.savefig('figures/tst_human.pdf', bbox_inches='tight')
plt.show()
